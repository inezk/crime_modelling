...
class KDE(Predictor):
    ...
    def predict(self, start_index, end_index, time_window, crime_types):
        ...
        for i in range(start_index, end_index):
            ...
            results[row_num: row_num + n_space,0] = "KDE"
